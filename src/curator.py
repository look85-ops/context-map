...
<header>
  ...
  <p class="desc">Дайджест собирает геополитический контекст, важный для переезда и адаптации: 7 разделов от обзорной карты до сценариев развития. Основа — мировые новости проанализированные ИИ. Не замена консультации.</p>
</header>
<main>
{body}
</main>
